...
const test = () => {
  ...
  const p = ((((pastWeekTotalBv * BigInt("397")) / BigInt("1000")) +
  ((priceFromVault * totalSupply)) / BigInt("1000000000000000000"))) * BigInt("1000000000000000000") /
  adjustedSupply;

const mintAmount = (((pastWeekTotalBv * BigInt("78")) / BigInt("1000")) *
  BigInt("1000000000000000000")) / p;
