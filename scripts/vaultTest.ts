...
import { AssetRightsCoin, MultiAssetVault } from "../types/ethers-contracts/index.js";
...
const updateSwapEnabled = async () => {
    ...
    const vaultContract = new BaseContract(vaultContractData.address, vaultContractData.abi, signers[0]) as MultiAssetVault;
...
const getVaultBalance = async () => {
    ...
    const daiContract = new BaseContract(daiContractData.address, daiContractData.abi, signers[0]) as AssetRightsCoin;
