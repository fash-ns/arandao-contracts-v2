...
const checkApproval = async () => {
  ...
  const allowance = await contract.allowance(
    "0xD5A49be076e72A772d9F78dFf77b8943E4b4E082",
    "0x6CE5ce6D69620AC43805bc6a84867daEC23E0c9B",
  );
...
const a = async () => {
  const txHash =
    "0xd4916c0b00b8077378df703e31563aaa40da1237cef45d32e35b5e27e75fc3a3";
...
const getUserCommissions = async () => {
  ...
  while (true) {
    ...
    if (user.withdrawableCommission !== BigInt(0)) {
      console.log(
        `UserId ${userId} has ${user.withdrawableCommission} commission to withdraw`,
      );
    }
    userId++;
  }
...
parseError(
  contractData.abi,
  "0xfb8f41b2000000000000000000000000fcc26d363e231303fd879a6431b2a5aac70ef4d50000000000000000000000000000000000000000000000024dce54d34a1a00000000000000000000000000000000000001e17b84357691b6403d0da800000000",
);
