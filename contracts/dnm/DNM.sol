...
contract DecentralizedNetworkMarketingV2 is ERC20, Ownable {
    mapping(address => bool) public isMintOperator;

    constructor(address recipient, uint256 initialSupply)
        ERC20("Decentralized Network Marketing V2", "DNM")
        Ownable(msg.sender)
    {
        _mint(recipient, initialSupply * 10 ** decimals());
    }

    function setMintOperator(address _operator, bool _isMintOperator) public onlyOwner {
