...
abstract contract ListingManager is OrderBookStorage {
    ...
    event ListingPurchased(uint256 indexed listingId, address indexed seller, address indexed buyer);
    ...
    function _createListing(address seller, uint256 tokenId, uint256 sellerPrice, uint256 buyerPrice, uint256 quantity)
        internal
    {
        ...
        emit ListingCreated(listingId, seller, supportedCollection, tokenId, sellerPrice, buyerPrice, quantity);
    }
    ...
    function _buyListing(uint256 listingId, address buyer, uint256 quantity) internal {
