...
abstract contract OfferManager is OrderBookStorage {
    ...
    event OfferCreated(
        uint256 indexed id, address indexed buyer, address collection, uint256 tokenId, uint256 quantity, uint256 price
    );
    ...
    function _createOffer(
        ...
        emit OfferCreated(offerId, buyer, supportedCollection, tokenId, quantity, buyerPrice);
    }
