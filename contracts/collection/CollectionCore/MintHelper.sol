...
abstract contract MintHelper is ERC1155, CollectionStorage {
  /// @dev Revert if the initial mint phase has been disabled.
  ...
  /// @dev Batch-mint `ids`/`amounts` to `to` during the initial mint phase.
  ...
  /// @dev Permanently disable the initial mint phase.
