    ...
    Helper
{
    ...
    function listTokenForSale(address collection, uint256 tokenId, uint256 sellerPrice, uint256 quantity)
        external
    ...
    function cancelListForSale(uint256 listingId) external nonReentrant {
        ...
        _handleNftTransferFrom(address(this), listing.seller, listing.collection, listing.tokenId, listing.quantity);
    }
    ...
    function acceptOffer(uint256 offerId, uint256 quantity) external nonReentrant {
        ...
        _handleNftTransferFrom(seller, offer.buyer, offer.collection, offer.tokenId, quantity);
