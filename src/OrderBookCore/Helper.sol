...
abstract contract Helper is OrderBookStorage {
    ...
    function _handleNftTransferFrom(address from, address to, address collection, uint256 tokenId, uint256 quantity)
        internal
    {
    ...
    function _checkCollection(address collection, uint256 quantity) internal view {
